...
include( $fts_plugin_rel_url.'feeds/facebook_custom/facebook_custom-feed.php' );
new FTS_Facebook_Custom_Feed();
include( $fts_plugin_rel_url.'feeds/twitter_custom/twitter_custom-feed.php' );
new FTS_Twitter_Custom_Feed();
