...
function  fts_instagram_head() {
    ...
    wp_enqueue_style( 'fts_instagram_custom_css', plugins_url( 'instagram/css/custom_smartapps.css',  dirname(__FILE__) ) );
...
// https://instagram.com/oauth/authorize/?client_id=[CLIENT_ID_HERE]&redirect_uri=http://localhost&response_type=token
    ...
    <div class="col-md-12 instagram-custom">
		<h4 class="col-md-10"><?= $title ?></h4>
    	<span class="fa fa-3x icon-instagram col-md-2"></span>
    	<div class="clear"></div>
    <?php
